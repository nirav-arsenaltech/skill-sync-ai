...
const styles = `
    ...
    .re-title    { font-size: 22px; font-weight: 800; color: var(--ss-text-strong); letter-spacing: -0.5px; }
    .re-subtitle { font-size: 13px; color: var(--ss-text-soft); margin-top: 4px; }
    ...
    .re-label-hint {
        font-size: 11px; font-weight: 400; color: var(--ss-text-muted);
        margin-left: 6px;
    }
    .re-input {
    ...
    .re-input::placeholder { color: var(--ss-text-muted); }
    .re-input:focus {
    ...
    .re-current-file-label { font-size: 11px; color: var(--ss-text-muted); font-weight: 600; text-transform: uppercase; letter-spacing: 0.6px; }
    ...
    .re-dropzone {
        ...
        background-image: url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='14' ry='14' stroke='var(--ss-alpha-12)' stroke-width='2' stroke-dasharray='8%2c 6' stroke-dashoffset='0' stroke-linecap='round'/%3e%3c/svg%3e");
    ...
    .re-drop-cta  { font-size: 14px; font-weight: 600; color: var(--ss-text-soft); margin-bottom: 5px; }
    .re-drop-cta span { color: #38bdf8; }
    .re-drop-hint { font-size: 12px; color: var(--ss-text-muted); margin-bottom: 14px; }
    ...
    .re-file-chip-size { font-size: 11px; color: var(--ss-text-muted); flex-shrink: 0; }
    .re-file-chip-remove {
    ...
    .re-divider {
        border: none;
        border-top: 1px solid var(--ss-alpha-06);
        margin: 28px 0;
    }
    ...
    .re-btn-cancel:hover { background: var(--ss-alpha-07); color: var(--ss-text-soft); }
