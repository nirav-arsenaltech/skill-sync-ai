...
const styles = `
    ...
    .ri-table { width: 100%; border-collapse: collapse; min-width: 720px; }
    ...
    @media (max-width: 767px) {
        .ri-root { padding: 20px 14px 36px; }
        .ri-search-row { flex-direction: column; align-items: stretch; }
        .ri-btn-search,
        .ri-btn-create { justify-content: center; width: 100%; }
    }
`;
