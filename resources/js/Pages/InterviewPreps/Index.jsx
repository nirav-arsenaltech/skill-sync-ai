...
export default function InterviewPrepIndex() {
    ...
    const handleDelete = () => {
        ...
        router.delete(`/interview-preps/${deleteId}`, {
            onSuccess: (page) => {
                // toast.success(page.props.flash?.success || 'Interview Prep.  Deleted successfully!');
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {InterviewPreps?.data?.length > 0 ? (
                                InterviewPreps.data.map((ip) => (
                                    ...
                                    >
                                        <td className="px-2 py-4 text-gray-800 dark:text-white w-16 text-center">{ip.id}</td>
                                        ...
                                        <td className="px-6 py-4 flex items-center space-x-4">
                                            ...
                                            <button
                                                ...
                                                title="view"
                                                onClick={() => Inertia.get(`/interview-preps/${ip.id}`)}
                                            >
                                                <EyeIcon className="h-5 w-5" />
                                            </button>
                                            {/* {ip.file_path ? (
                                                <a
                                                    href={`/storage/${ip.file_path}`}
                                                    download
