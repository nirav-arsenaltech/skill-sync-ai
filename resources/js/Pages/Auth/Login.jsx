...
const styles = `
    ...
    .auth-remember {
        ...
        font-size: 13px; color: var(--ss-text-soft); cursor: pointer;
        user-select: none;
    }
    .auth-checkbox {
    ...
    .auth-divider-line {
        flex: 1; height: 1px; background: var(--ss-alpha-14);
    }
    .auth-divider-text { font-size: 12px; color: var(--ss-text-muted); white-space: nowrap; }

    /* Bottom link */
    .auth-bottom {
        text-align: center; font-size: 13px; color: var(--ss-text-muted);
    }
    .auth-bottom a {
