...
const styles = `
    ...
    .ji-root { font-family: 'Inter', sans-serif; padding: 28px 28px 48px; background: var(--ss-bg); min-height: 100%; }

    /* Header */
    .ji-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; flex-wrap: wrap; gap: 12px; }
    .ji-header-left {}
    .ji-title    { font-size: 22px; font-weight: 800; color: var(--ss-text-strong); letter-spacing: -0.5px; }
    .ji-subtitle { font-size: 13px; color: var(--ss-text-muted); margin-top: 3px; }
    ...
    .ji-search-input::placeholder { color: var(--ss-text-muted); }
    ...
    .ji-search-clear:hover { color: var(--ss-text-soft); }
    ...
    .ji-table tbody tr:hover td { background: var(--ss-alpha-02); }
    .ji-table td.ji-td-id   { color: var(--ss-text-muted); font-size: 12px; text-align: center; width: 56px; }
    .ji-table td.ji-td-title { color: var(--ss-text); font-weight: 500; }
    ...
    .ji-empty-text { font-size: 14px; color: var(--ss-text-muted); font-weight: 500; margin-bottom: 16px; }
    ...
    .ji-per-page { display: flex; align-items: center; gap: 8px; font-size: 13px; color: var(--ss-text-muted); }
    .ji-per-page-select {
        background: var(--ss-surface); border: 1px solid var(--ss-alpha-08);
    ...
    .ji-per-page-total { color: var(--ss-text-muted); }
    ...
    .ji-page-btn:hover { background: var(--ss-alpha-05); color: var(--ss-text-soft); }
    ...
    .ji-modal-close:hover { background: var(--ss-alpha-09); color: var(--ss-text-soft); }
    .ji-modal-icon {
        width: 48px; height: 48px; border-radius: 14px;
        background: rgba(248,113,113,0.12); border: 1px solid rgba(248,113,113,0.22);
        display: flex; align-items: center; justify-content: center; margin-bottom: 16px;
    }
    .ji-modal-title { font-size: 17px; font-weight: 700; color: var(--ss-text-strong); margin-bottom: 8px; }
    .ji-modal-desc  { font-size: 14px; color: var(--ss-text-muted); line-height: 1.6; margin-bottom: 24px; }
    ...
    .ji-modal-cancel:hover { background: var(--ss-alpha-08); color: var(--ss-text-soft); }
    .ji-modal-delete {
        padding: 9px 20px; border-radius: 9px;
